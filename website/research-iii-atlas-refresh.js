(() => {
  const RESEARCH_III_PIN = 'c8694e86de229fefa91b343066da8be8b29da4b2';
  ...
  const LEGACY_PINS = ['c8694e86de229fefa91b343066da8be8b29da4b2'];
  ...
  function repinValue(value) {
    ...
    updated = updated.replace(
      'github.com/MahsaKeikha/consciousness-measurement-science/blob/c8694e86de229fefa91b343066da8be8b29da4b2/',
      `github.com/MahsaKeikha/consciousness-measurement-science/blob/${RESEARCH_III_PIN}/`,
    );
    updated = updated.replace(
      'github.com/MahsaKeikha/consciousness-measurement-science/tree/c8694e86de229fefa91b343066da8be8b29da4b2/',
      `github.com/MahsaKeikha/consciousness-measurement-science/tree/${RESEARCH_III_PIN}/`,
    );
    updated = updated.replace(
      'raw.githubusercontent.com/MahsaKeikha/consciousness-measurement-science/c8694e86de229fefa91b343066da8be8b29da4b2/',
  ...
  function renderResearchIIISources() {
    ...
    block.innerHTML = `
      ...
      <div class="source-section-visual-links"><a href="${MEASUREMENT_REPO}/blob/${RESEARCH_III_PIN}/VALIDATION.md">Validation program</a><a href="${MEASUREMENT_REPO}/blob/${RESEARCH_III_PIN}/docs/validation-atlas.md">Validation atlas</a><a href="${MEASUREMENT_REPO}/blob/${RESEARCH_III_PIN}/results/README.md">Result index</a><a href="${MEASUREMENT_REPO}/tree/${RESEARCH_III_PIN}/tests">194-test suite</a></div>
      <div class="r3-validation-grid">${VALIDATION_FIGURES.map(validationCard).join('')}</div>`;
  ...
  function renderResearchIIIMeasurementPage() {
    ...
    if (status) {
      ...
      if (cells[2]) cells[2].innerHTML = '<strong>194</strong><span>tests in each CI job</span>';
