(() => {
  ...
  const MEASUREMENT_PIN = '0072642d93d77fa594634a643e46e73769af0655';
  ...
  const PAGE_CONTRACTS = {
    'index.html': {
      ...
      established:
        'The site documents a three-stage program: physical-system identification in Research I, bridge sufficiency and falsification through P100 in Research II, and a V1-V45 formal measurement-validation program in Research III.',
      open:
      ...
      links: [
        ...
        ['measurement-science.html', 'Open Research III V1-V45'],
      ],
    },
    'plain-language.html': {
    ...
    'research-lineage.html': {
      ...
      established:
        'The lineage separates physical-system identification, bridge sufficiency testing, and measurement science so outputs from one stage are not silently promoted into conclusions belonging to another. Research III now adds V1-V45 formal validation and measurement-design laws.',
      open:
      ...
      links: [
        ...
        ['measurement-science.html', 'Inspect Research III V1-V45'],
      ],
    },
    'research-map.html': {
      stage: 'Research II',
    ...
    'measurement-science.html': {
      ...
      links: [
        [`${MEASUREMENT_REPO}/blob/${MEASUREMENT_PIN}/VALIDATION.md`, 'Open the V1-V45 validation program'],
    ...
    'sources.html': {
      ...
      established:
        'The Sources page separates Research I physical-system provenance, Research II P1-P100 theorem provenance, and Research III architecture from its V1-V45 executable validation record. Each Research III validation visual links to the exact derivation, machine-readable result data, and figure source at one pinned commit.',
      open:
    ...
    if (journey) {
      ...
      if (node) {
        node.innerHTML = `
          ...
          <p><strong>Current record:</strong> V1-V45 formal validation, deterministic simulations, 20 generated result figures, CSV/JSON outputs, theorem tests, and CI across Python 3.10, 3.11, and 3.12.</p>
