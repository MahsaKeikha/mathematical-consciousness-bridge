(() => {
  ...
  const MEASUREMENT_PIN = 'c8694e86de229fefa91b343066da8be8b29da4b2';
  ...
  const PAGE_CONTRACTS = {
    'index.html': {
      ...
      established:
        'The site documents a three-stage program: physical-system identification in Research I, bridge sufficiency and falsification through P100 in Research II, and a V1-V55 formal measurement-validation program in Research III.',
      open:
      ...
      links: [
        ...
        ['measurement-science.html', 'Open Research III V1-V55'],
      ],
    },
    'plain-language.html': {
    ...
    'research-lineage.html': {
      ...
      established:
        'The lineage separates physical-system identification, bridge sufficiency testing, and measurement science so outputs from one stage are not silently promoted into conclusions belonging to another. Research III now adds V1-V55 formal validation and measurement-design laws.',
      open:
      ...
      links: [
        ...
        ['measurement-science.html', 'Inspect Research III V1-V55'],
      ],
    },
    'research-map.html': {
      stage: 'Research II',
    ...
    'measurement-science.html': {
      ...
      links: [
        [`${MEASUREMENT_REPO}/blob/${MEASUREMENT_PIN}/VALIDATION.md`, 'Open the V1-V55 validation program'],
    ...
    'sources.html': {
      ...
      established:
        'The Sources page separates Research I physical-system provenance, Research II P1-P100 theorem provenance, and Research III architecture from its V1-V55 executable validation record. Each Research III validation visual links to the exact derivation, machine-readable result data, and figure source at one pinned commit.',
      open:
    ...
    if (journey) {
      ...
      if (node) {
        node.innerHTML = `
          ...
          <p><strong>Current record:</strong> V1-V55 formal validation, deterministic simulations, 22 generated result figures, CSV/JSON outputs, theorem tests, and CI across Python 3.10, 3.11, and 3.12.</p>
  ...
  function loadResearchIIIAtlasRefresh() {
    ...
    loadScriptOnce('research-iii-atlas-refresh.js?v=20260919-r3-redesigned-figures', 'data-research-iii-atlas-refresh');
  }
