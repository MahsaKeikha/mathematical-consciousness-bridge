(() => {
  ...
  const MEASUREMENT_PIN = 'edc1db943d6efe8bdc679dbc5d77ecb7633476ab';
  ...
  const PAGE_CONTRACTS = {
    'index.html': {
      ...
      established:
        'The site documents a three-stage program: physical-system identification in Research I, bridge sufficiency and falsification through P100 in Research II, and a V1-V50 formal measurement-validation program in Research III.',
      open:
      ...
      links: [
        ...
        ['measurement-science.html', 'Open Research III V1-V50'],
      ],
    },
    'plain-language.html': {
    ...
    'research-lineage.html': {
      ...
      established:
        'The lineage separates physical-system identification, bridge sufficiency testing, and measurement science so outputs from one stage are not silently promoted into conclusions belonging to another. Research III now adds V1-V50 formal validation and measurement-design laws.',
      open:
      ...
      links: [
        ...
        ['measurement-science.html', 'Inspect Research III V1-V50'],
      ],
    },
    'research-map.html': {
      stage: 'Research II',
    ...
    'measurement-science.html': {
      ...
      established:
        'Research III contains a reproducible V1-V50 formal validation program covering calibrated inversion, partial identification, finite-sample coverage, transport bias, channel dependence, structural null and power testing, calibration uncertainty, arbitrary missingness, inverse conditioning, multisite identification, exact missingness-information loss, resolution sample-size design, independent pilot release gating, sensor-level electromagnetic measurement, source non-identifiability, inverse resolution and information limits, spatial-specificity diagnostics, sensor-design information geometry, finite-sample covariance and discrimination checks, multiplicity control, exact sign-flip inference, post-selection coverage failure, independent holdout confirmation, common-effect cross-site pooling, heterogeneity auditing, leave-one-site-out influence, partial-conjunction replicability, and site-weight concentration.',
      open:
      ...
      links: [
        [`${MEASUREMENT_REPO}/blob/${MEASUREMENT_PIN}/VALIDATION.md`, 'Open the V1-V50 validation program'],
    ...
    'visual-atlas.html': {
      ...
      established:
        'The Atlas uses one explicit gallery language across all three programs. Research I exposes its scientific-result figures, Research II renders its canonical theorem and architecture record, and Research III exposes 9 foundational architecture visuals plus 21 code-generated V1-V50 validation-result figures.',
      open:
    ...
    'sources.html': {
      ...
      established:
        'The Sources page separates Research I physical-system provenance, Research II P1-P100 theorem provenance, and Research III architecture from its V1-V50 executable validation record. Each Research III validation visual links to the exact derivation, machine-readable result data, and figure source at one pinned commit.',
      open:
    ...
    if (journey) {
      ...
      if (node) {
        node.innerHTML = `
          ...
          <p>Model the observable channel explicitly, prove when latent inference is identifiable, propagate calibration and finite-sample uncertainty, stress dependence and transport, quantify multisite and missing-data information loss, design selection-safe release rules, and test electromagnetic field observables against gain, power-only, nuisance, and frequency-specific counterexamples, then stress source reconstruction with reference, null-space, regularization, multimodal, and forward-model perturbation tests, followed by covariance-aware residual geometry, inverse-resolution leakage, Fisher-information limits, temporal aliasing, singular-direction noise amplification, point-spread and cross-talk analysis, information-aware sensor design, nuisance-loss quantification, robust model-uncertainty bounds, and finite-sample inference checks for covariance estimation, Gaussian source discrimination, multiplicity, and sandwich uncertainty calibration, followed by arbitrary-dependence FWER control, Holm step-down testing, exact sign-flip inference, post-selection coverage analysis, independent holdout confirmation, and cross-site replication stability through heterogeneity, leave-one-site-out, partial-conjunction, and site-weight diagnostics.</p>
          <p><strong>Current record:</strong> V1-V50 formal validation, deterministic simulations, 21 generated result figures, CSV/JSON outputs, theorem tests, and CI across Python 3.10, 3.11, and 3.12.</p>
