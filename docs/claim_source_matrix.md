...
| --- | --- | --- | --- | --- |
| Current theorem count | The current repository contains 87 proposition-level results | repository publication status | theorem roadmap, verifier, reader tests, and current website source | this is a repository count, not an external scientific consensus statement |
| Current frontier | P87 is the current theorem frontier | repository publication status | P86 proof, implementation, tests, provenance, figure, and frontier publication tests | P84 and P85 remain historical certified frontiers, not current ones |
