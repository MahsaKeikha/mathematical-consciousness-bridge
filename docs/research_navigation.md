...
13. [P79 bounded target-view dependence](proposition_79_bounded_target_view_dependence.md) for robust P77/P78 rejection after an independently justified residual-dependence allowance is added to sampling uncertainty.
...
18. [P61-P70 Calibration and Optimization Frontier](calibration_optimization_frontier_p61_p70.md) for downstream integer resource-allocation mathematics.
19. [Equation and citation map](equation_and_citation_map.md) for equation-level provenance and theorem lineage.
20. [P72 equation and provenance record](p72_equation_provenance.md) for the standard-versus-repository classification of the noisy-target theorem.
21. [P73 equation and provenance record](p73_equation_provenance.md) for latent-class context, moment inversion, and the P72 stability connection.
22. [P74 equation and provenance record](p74_equation_provenance.md) for finite-sample concentration, nonlinear interval propagation, and full-channel recovery.
23. [P75 equation and provenance record](p75_equation_provenance.md) for just-identification, overidentification, algebraic adequacy constraints, and full-law reconstruction provenance.
24. [Falsification program](falsification_program.md) for the empirical burden required before any bridge claim can be accepted.
...
| P79 | [Bounded target-view dependence robustness](proposition_79_bounded_target_view_dependence.md) | robust model rejection with independently justified local-dependence budget |
