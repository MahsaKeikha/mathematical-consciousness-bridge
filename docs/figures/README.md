...
![P88 current theorem frontier](p88_exact_radius3_bounded_primitive_quad_projection_parity.svg)

Canonical current-frontier figure: `p88_exact_radius3_bounded_primitive_quad_projection_parity.svg`
...
- `p88_exact_radius3_bounded_primitive_quad_projection_parity.svg`
