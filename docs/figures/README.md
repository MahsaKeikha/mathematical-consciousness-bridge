...
![P88 current theorem frontier](p88_exact_radius_three_bounded_primitive_quad_projection_parity.svg)

Canonical current-frontier figure: `p88_exact_radius_three_bounded_primitive_quad_projection_parity.svg`
