...
## Current frontier: P95

![P95 current theorem frontier](p95_drift_aware_stratified_sign_coherence.svg)

Canonical current-frontier figure: `p95_drift_aware_stratified_sign_coherence.svg`
