...
## Current frontier: P96

![P96 current theorem frontier](p96_selection_valid_holdout_stratification.svg)

Canonical current-frontier figure: `p96_selection_valid_holdout_stratification.svg`
