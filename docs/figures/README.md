...
## Current frontier: P97

![P97 current theorem frontier](p97_simultaneous_candidate_family_selection.svg)

Canonical current-frontier figure: `p97_simultaneous_candidate_family_selection.svg`
