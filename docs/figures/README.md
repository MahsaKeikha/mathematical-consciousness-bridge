...
![P88 current theorem frontier](p88_heldout_selected_parity_functional_certification.svg)

Canonical current-frontier figure: `p88_heldout_selected_parity_functional_certification.svg`
