...
| --- | --- | --- | --- |
| Tegmark, 2015 | *Chaos, Solitons & Fractals* 76, 238-270. DOI: [10.1016/j.chaos.2015.03.014](https://doi.org/10.1016/j.chaos.2015.03.014); [arXiv:1401.1219](https://arxiv.org/abs/1401.1219) | important conceptual starting point for questions about physical subsystem structure, information, integration, independence, dynamics, and factorization; the later proposition sequence develops a distinct mathematical framework with its own proof and reproducibility record | peer-reviewed theoretical/conceptual physics paper used as research-origin background |
