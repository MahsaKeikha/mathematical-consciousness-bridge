...
| --- | --- | --- | --- |
| Tegmark, 2015 | *Chaos, Solitons & Fractals* 76, 238-270. DOI: [10.1016/j.chaos.2015.03.014](https://doi.org/10.1016/j.chaos.2015.03.014); [arXiv:1401.1219](https://arxiv.org/abs/1401.1219) | intellectual starting point for questions about physical subsystem structure, information, integration, independence, dynamics, and factorization; not evidential support for later repository-original propositions | peer-reviewed theoretical/conceptual physics paper used as research-origin background |
