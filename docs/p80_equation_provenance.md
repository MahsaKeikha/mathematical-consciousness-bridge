...
| P78 coordinate threshold | $r_\square=\max_i d(\widehat p_i,[\ell_i,u_i])$ | Inherited product-box $L_\infty$ distance | [P78 proof](proposition_78_certified_continuous_model_separation.md) and [P80 exact-feasibility proof](proposition_80_simplex_coupled_model_separation.md) |
| Radius feasibility | $r\ge r_\square$ and $\sum_i\max(\ell_i,\widehat p_i-r)\le1\le\sum_i\min(u_i,\widehat p_i+r)$ | Coordinatewise overlap plus exact interval-sum feasibility | [P80 exact-feasibility proof](proposition_80_simplex_coupled_model_separation.md) |
