...
The module audits whether any two components of a labeled IRCG fingerprint can
reconstruct the three-component fingerprint on a declared finite domain. It does
not infer consciousness and does not establish global minimality of every possible
IRCG representation.
"""
...
from consciousness_bridge.ircg_minimality import projection_collision
...
def component_projection(
    ...
    if unknown:
        raise ValueError(f"Unknown IRCG component names: {unknown}")
