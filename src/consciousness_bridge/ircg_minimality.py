"""Finite projection-collision tools for Proposition 12.

These utilities test whether a compressed physical feature can reconstruct a richer
IRCG fingerprint on a declared finite benchmark. They do not infer consciousness.
"""
