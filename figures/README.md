...
![P88 current theorem frontier](../docs/figures/p88_exact_expanded_bounded_primitive_quad_projection_parity.svg)

Canonical figure: [`p88_exact_expanded_bounded_primitive_quad_projection_parity.svg`](../docs/figures/p88_exact_expanded_bounded_primitive_quad_projection_parity.svg)
Theorem: [`proposition_88_exact_expanded_bounded_primitive_quad_projection_parity_functional.md`](../docs/proposition_88_exact_expanded_bounded_primitive_quad_projection_parity_functional.md)
