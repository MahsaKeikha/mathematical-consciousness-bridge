...
[![version](https://img.shields.io/badge/version-0.62.0-2563eb)](CITATION.cff)
...
The public research record now contains **62 proposition-level results, 59 equation-driven quantitative figures, quantum and classical physical maps, reproducible numerical examples, counterexamples, and a multi-version Python test matrix**.
