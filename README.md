...
[![version](https://img.shields.io/badge/version-0.48.0-2563eb)](CITATION.cff)
...
The public research record now contains **48 proposition-level results, 58 equation-driven quantitative figures, quantum and classical physical maps, reproducible numerical examples, counterexamples, and a multi-version Python test matrix**.
...
| --- | --- | --- |
| complete theorem chain | [Theorem Roadmap](docs/theorem_roadmap.md) | P1 through P48 with explicit dependency branches |
