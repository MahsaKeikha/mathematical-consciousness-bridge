...
After generation and enrichment, reader-facing documentation punctuation is
normalized before publication synchronization. This keeps regenerated SVG and
text surfaces consistent with the repository's ASCII punctuation contract.
