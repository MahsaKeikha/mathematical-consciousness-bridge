...
After generation and enrichment, reader-facing SVG arrowheads are normalized
to fixed user-space geometry and documentation punctuation is normalized before
publication synchronization. This keeps regenerated SVG and text surfaces
consistent with the repository's visual and ASCII punctuation contracts.
...
ARROWHEAD_NORMALIZER = ROOT / "scripts" / "normalize_svg_arrowheads.py"
...
def main() -> None:
    ...
    if args.validate_only:
        validate_figures()
        _run_script(ARROWHEAD_NORMALIZER, "--check")
    ...
    _run_script(ARROWHEAD_NORMALIZER)
