...
def _p88_visual_section() -> str:
  ...
  <div class="theorem-figure-shell">
    <a href="{BLOB_PREFIX}docs/figures/p88_exact_expanded_bounded_primitive_quad_projection_parity.svg" aria-label="Open the full P88 theorem figure">
      <img loading="eager" decoding="async" src="{RAW_FIGURE_PREFIX}p88_exact_expanded_bounded_primitive_quad_projection_parity.svg" alt="P88 expanded bounded primitive four-event parity certificate showing L87 equals one over 96 and L88 equals one over 64" />
    </a>
  </div>
  ...
  <p><a href="{BLOB_PREFIX}docs/proposition_88_exact_expanded_bounded_primitive_quad_projection_parity_functional.md">Open the P88 theorem</a> · <a href="{BLOB_PREFIX}docs/p88_equation_provenance.md">Equation provenance</a> · <a href="{BLOB_PREFIX}src/consciousness_bridge/expanded_bounded_primitive_quad_projection_parity_functional_separation.py">Implementation</a> · <a href="{BLOB_PREFIX}tests/test_expanded_bounded_primitive_quad_projection_parity_functional_separation.py">Exact tests</a></p>
</section>'''
