...
def test_nested_contrast_enclosure_for_strict_witness_is_exactly_as_expected() -> None:
    ...
    enclosure = p75_nested_projection_contrast_enclosure_exact(
        box,
        parent_views,
        parent_assignment,
        child_views,
    ...
    assert enclosure == (Fraction(0), Fraction(1, 4))
...
def test_p82_source_states_scope_and_scientific_boundary() -> None:
    source = Path(
