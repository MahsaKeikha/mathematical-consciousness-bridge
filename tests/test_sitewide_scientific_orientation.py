...
def test_research_three_orientation_keeps_intro_with_heading() -> None:
    ...
    assert "research-orientation.css?v=20260919-r3-figure-scale" in app
    assert "research-orientation.js?v=20260919-r3-figure-scale" in app
    assert "research-iii-atlas-refresh.js?v=20260919-r3-figure-scale" in orientation
