...
def test_p59_p61_legacy_text_is_contained_inside_every_declared_block():
...
def test_p59_p61_legacy_connectors_reference_existing_blocks():
...
def test_p59_p61_legacy_figures_have_no_forbidden_unicode_dashes():
    for proposition, (filename, _) in LEGACY_FIGURES.items():
