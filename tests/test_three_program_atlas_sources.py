...
def test_sitewide_orientation_describes_atlas_and_sources_as_three_program_surfaces() -> None:
    ...
    assert "Research III now exposes 9 foundational architecture visuals plus 10 code-generated V1-V10 validation-result figures" in orientation
    ...
    assert "Research III architecture from its V1-V10 executable validation record" in orientation
