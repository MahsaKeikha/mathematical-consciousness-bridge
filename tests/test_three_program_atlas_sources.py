...
def test_sources_links_each_program_to_its_real_audit_record() -> None:
    ...
    for token in (
        ...
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/epistemic-boundaries.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/measurement-framework.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/statistical-validation.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/reproducibility.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/electromagnetic-field-program.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/electromagnetic-source-identifiability.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/electromagnetic-resolution-program.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/electromagnetic-design-spatial-specificity.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/electromagnetic-finite-sample-inference.md",
        "consciousness-measurement-science/blob/c6415f2d50d68b664860f43e9da440d0a36c2997/docs/electromagnetic-source-identifiability.md",
        "consciousness-measurement-science/tree/c6415f2d50d68b664860f43e9da440d0a36c2997/schemas",
    ):
...
def test_three_program_cards_are_native_links_and_static_metrics_do_not_mimic_links() -> None:
    ...
    assert atlas.count('<a class="program-visual-card"') == 12
    assert sources.count('<a class="program-source-card"') == 27
