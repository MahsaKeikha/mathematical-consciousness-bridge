...
def test_readme_follows_reader_first_scientific_order():
    ...
    assert formulation < p71 < p72 < operational < scale < finite < fundamental
...
def test_detailed_record_preserves_full_p1_to_p72_chronology_off_main_page():
